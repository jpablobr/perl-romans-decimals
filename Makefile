# This Makefile is for the Math::Roman extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Math/Roman.pm]
#     AUTHOR => q[jpablobr <jpablobr@>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Math::Roman]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Math/Roman.pm]
...
PARENT_NAME = Math
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Math/Roman.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Math/Roman.pm

PM_TO_BLIB = lib/Math/Roman.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Math/Roman.pm $(INST_MAN3DIR)/Math::Roman.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Math-Roman' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for blah blah blah' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - jpablobr <jpablobr@>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>jpablobr &lt;jpablobr@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Math/Roman.pm blib/lib/Math/Roman.pm 
